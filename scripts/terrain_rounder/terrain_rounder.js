	...
	while (!InputFileObject.AtEndOfStream)
	{
		...
		if (LineType == '3')
		{
			...
			var NewTempString = '3 ' + LineColor + ' ' +
				Math.round(TempArray[2]/StepMultiple) * StepMultiple + ' ' + TempArray[3] + ' ' + Math.round(TempArray[4]/StepMultiple) * StepMultiple + ' ' +
				Math.round(TempArray[5]/StepMultiple) * StepMultiple + ' ' + TempArray[6] + ' ' + Math.round(TempArray[7]/StepMultiple) * StepMultiple + ' ' +
				Math.round(TempArray[8]/StepMultiple) * StepMultiple + ' ' + TempArray[9] + ' ' + Math.round(TempArray[10]/StepMultiple) * StepMultiple;
